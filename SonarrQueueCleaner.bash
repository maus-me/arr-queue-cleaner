...
CleanerProcess() {
    ...
    arrQueueData="$(curl -s "$arrUrl/api/v3/queue?page=1&pagesize=40&sortDirection=descending&sortKey=progress&includeUnknownSeriesItems=true&apikey=${arrApiKey}" | jq -r .records[])"
